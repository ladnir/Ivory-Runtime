...
namespace osuCrypto
{
    ...
    BetaCircuit * osuCrypto::BetaLibrary::int_int_add(u64 aSize, u64 bSize, u64 cSize)
    {
    ...
    BetaCircuit * BetaLibrary::int_int_mult(u64 aSize, u64 bSize, u64 cSize)
    {
    ...
    void BetaLibrary::int_int_add_build(
        BetaCircuit& cd,
        BetaBundle & a1,
        BetaBundle & a2,
        BetaBundle & sum,
